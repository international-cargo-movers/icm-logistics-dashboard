                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.headerRow}>
                        ...
                        <View style={styles.col50NoBorder}>
                            ...
                            <View style={[styles.gridRow, { borderBottom: 'none' }]}>
                                <View style={styles.gridColNoBorder}><Text style={styles.label}>AD CODE</Text><Text style={styles.value}>{ship.adCode}</Text></View>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.headerRow}>
                        ...
                        <View style={styles.col50NoBorder}>
                            <View style={styles.gridRow}>
                                <View style={styles.gridCol}><Text style={styles.label}>Country of origin of goods</Text><Text style={styles.value}>{ship.countryOfOrigin}</Text></View>
                    ...
                    <View style={styles.bankRow}>
                        <View style={styles.bankCol}>
                            ...
                            <View style={{ marginTop: 5 }}>
                                <Text style={styles.label}>OUR BANK DETAILS: {exp.name}</Text>
